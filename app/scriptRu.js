...
let thText = ['№','Команда/ участник','ФИО Участников','Город',
'Организация','Тренер','Судья-1','Судья-2','Судья-3','Судья-4','Судья-5','Судья-6','Штраф','Балл'],
...
sortButton.innerText = 'Найти победителя';
